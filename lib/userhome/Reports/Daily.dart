...
class _MyHomePageState extends State<Daily> {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        SfCartesianChart(
            ...
            // Chart title
            title: ChartTitle(text: 'Daily analysis of fuel consumption'),
            // Enable legend
      ...
      Column(children:[TextButton(
          ...
          child:Text('Daily', style: TextStyle(fontSize: 18.0,color: Colors.orange,
      ...
      Column(children:[TextButton(
          ...
          child:Text('Weekly', style: TextStyle(fontSize: 18.0,color: Colors.orange,
            fontWeight: FontWeight.bold,)))]),
        Column(children:[TextButton(
            onPressed: () {
              Navigator.push(
            ...
            child:Text('Monthly', style: TextStyle(fontSize: 18.0,color: Colors.orange,
              fontWeight: FontWeight.bold,)))]),
          Column(children:[Text('    ', style: TextStyle(fontSize: 20.0))]),
        ]),
      ],
